...
will also succeed. The difference still though is that GitHub Action will also run some of these tests on the MSRV (`1.88`) and three platforms in total: MacOS, Linux and Windows.
